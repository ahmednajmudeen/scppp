...
#download
wget -O /usr/local/bin/PDirect.py https://raw.githubusercontent.com/project-vps/ngopi/main/install/PDirect.py
...
wget -O /usr/local/bin/ovpn.py https://raw.githubusercontent.com/project-vps/ngopi/main/install/ovpn.py
